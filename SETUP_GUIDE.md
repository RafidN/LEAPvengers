...
4. ✓ **Builds Backend** - Runs `mvn clean install` for the Spring Boot application
5. ✓ **Installs Frontend Dependencies** - Installs npm packages for Angular
6. ✓ **Starts Backend** - Launches Spring Boot on `http://localhost:8081/api` in a new terminal
7. ✓ **Starts Frontend** - Launches Angular dev server on `http://localhost:4200` in a new terminal
